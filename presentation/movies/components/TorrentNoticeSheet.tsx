...
export function TorrentNoticeSheet({torrent, onClose, bottomInset}: TorrentNoticeSheetProps) {
    ...
    const body = (
    <View
        style={[styles.inner, {paddingBottom: isLarge ? Spacing.lg : bottomInset + Spacing.lg}]}
    ...
    if (isLarge) {
        return (
            <Modal visible={torrent != null} transparent animationType="fade" onRequestClose={onClose}>
                <Pressable
