...
| [Expo #47639](https://github.com/expo/expo/pull/47639) | Remove the dev-launcher factory’s old bridge branch, controller bridge conformance, obsolete packager interception, and dead Unsafe/Main CocoaPods subspecs. This cleanup is confined to iOS sources and the iOS podspec. |
