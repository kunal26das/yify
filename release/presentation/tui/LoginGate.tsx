...
export function LoginGate({
    ...
    if (mode === 'enterKey') {
        return (
            <Box flexDirection="column">
                <Text color="yellow">Paste your Expo access token:</Text>
    ...
    const items = [
        ...
        {label: 'Paste access token & sign in', value: 'key' as const},
    ...
    return (
        <Box flexDirection="column">
            <Text color="yellow">You are not logged in to Expo.</Text>
